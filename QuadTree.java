...
public class QuadTree<T> {
    ...
    /*
        method: generateBoundaryBox
        arguments:x and y values of a coordinate/point
        returns: coordinates of the lower left and upper right corners of the boundary box
                 inside of an array

        this method was added by Micah Haycraft for a specific use case of
        the quadtree ADT.
        from a given coordinate it generates the corners of a boundary box
        to be used with the searchWithin method
     */
    public double[] generateBoundaryBox(double x, double y){

        double[] returnArray = new double[4]; // array for returning two points that define the
        //the bottom left and top right corners of a boundary box
        //array values are xmin, ymin, xmax, ymax in that order

        /*

        I am converting a distance of approx 43m into decimal degrees to add and subtract from
        the x and y values of a given point in order to generate a hypotenuse of approx 86m
        which will define the bottom left and top right corners of a square with side length
        of approx 60.9m and a square area of approx 3708.81 square meters

         */

        final double distToCorner = 0.000295; //approx a distance of 43 meters converted to decimal degrees
